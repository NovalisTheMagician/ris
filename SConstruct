...
client = Program('RIS', client_objs + common_objs, LIBS=client_libs, LIBPATH=client_lib_path)
server = Program('RIS_server', server_objs + common_objs, LIBS=server_libs, LIBPATH=server_lib_path)
